(function () {
  ...
  function renderPlans(plans, list) {
    ...
    plans.forEach(function (plan) {
      ...
      var article = document.createElement('article'); article.className = 'relative flex flex-col rounded-xl border ' + (code === 'FREE' ? 'border-emerald-200' : code === 'PRO' ? 'border-violet-200' : 'border-blue-300') + ' bg-white p-6 shadow-soft';
